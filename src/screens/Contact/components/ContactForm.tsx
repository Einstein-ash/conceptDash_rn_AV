...
// src/screens/Contact/components/ContactForm.tsx
...
const ContactForm: React.FC<ContactFormProps> = ({ formType }) => {
  const [agreed, setAgreed] = useState(false);
  const placeholderColor = "#8E8E93"; // Define a visible color

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Request a Proposal / <Text style={{ color: '#333' }}>{formType} Form</Text></Text>
      <View style={styles.row}>
        <TextInput style={styles.input} placeholder="First Name *" placeholderTextColor={placeholderColor} />
        <TextInput style={styles.input} placeholder="Last Name *" placeholderTextColor={placeholderColor} />
      </View>
      <View style={styles.row}>
        <TextInput style={styles.input} placeholder="Country *" placeholderTextColor={placeholderColor} />
        <TextInput style={styles.input} placeholder="Sub-Department *" placeholderTextColor={placeholderColor} />
      </View>
      <View style={styles.row}>
        <TextInput style={styles.input} placeholder="Email *" placeholderTextColor={placeholderColor} />
        <TextInput style={styles.input} placeholder="Phone Number" placeholderTextColor={placeholderColor} />
      </View>
      <TextInput style={styles.inputFull} placeholder="Write Your Message" placeholderTextColor={placeholderColor} multiline />
      <View style={styles.attachmentContainer}>
        <Text style={styles.attachmentTitle}>Add Attachment</Text>
        <Text style={styles.attachmentNote}>Note: File size should not exceed 10MB.</Text>
        <Text style={styles.attachmentNote}>Accepted types: .pdf, .docx, .pptx, .xls, .zip, .jpeg, .png</Text>
